        ...
        {user ? (
          <div className="flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
            ...
            <div className="flex items-center gap-3 pl-3 border-l border-[#2B2B43]">
              ...
              />
              <button onClick={logout} className="ml-1 p-1.5 hover:bg-[#2A2E39] rounded-md text-gray-400 hover:text-red-400">
                <LogOut size={16} />
              </button>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            <Link href="/login" className="bg-blue-600 hover:bg-blue-700 text-white text-xs px-4 py-2 rounded font-bold transition-all">
              Login
            </Link>
            <Link href="/register" className="bg-[#2A2E39] hover:bg-[#363a45] text-white text-xs px-4 py-2 rounded font-bold border border-[#2B2B43]">
              Register
            </Link>
          </div>
        )}
